...
const GOOGLE_API_KEY = "AIzaSyBKGIBUjTrZZj0GU3S91U7spUgu4V7BQXg";
    ...
    savedConversations.forEach(conversation => {
        ...
        const userMessageHtml = `
            ...
            <div class="message__content">
                <img class="message__avatar" src="assets/GeoAi-Logo.webp" alt="User avatar">
...
const handleOutgoingMessage = () => {
    ...
    const outgoingMessageHtml = `
        ...
        <div class="message__content">
            <img class="message__avatar" src="assets/user.webp" alt="User avatar">
            <p class="message__text"></p>
        </div>
